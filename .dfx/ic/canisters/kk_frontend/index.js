...
import { idlFactory } from './kk_frontend.did.js';
export { idlFactory } from './kk_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.KK_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kk_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kk_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kk_frontend.did.js")._SERVICE>}
 */
export const kk_frontend = createActor(canisterId);
